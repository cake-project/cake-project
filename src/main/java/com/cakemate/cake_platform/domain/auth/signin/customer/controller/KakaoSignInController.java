...
public class KakaoSignInController {
    ...
    public KakaoSignInController(CustomerSignInService customerSignInService) {
    ...
    public ApiResponse<CustomerSignInResponse> handleRedirect(@RequestParam String code) {
        ...
        log.info("code {} ", code);
        ApiResponse<CustomerSignInResponse> customerSignInProcess =  customerSignInService.CustomerSignInProcess(code);
