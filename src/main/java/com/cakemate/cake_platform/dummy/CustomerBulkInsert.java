...
public class CustomerBulkInsert {
    ...
    public CustomerBulkInsert(PasswordEncoder encoder) {
    ...
    private void insertRange(int start, int end) {
        String sql = "INSERT INTO customers (email, password, password_confirm, name, phone_number, created_at, modified_at) "
                + "VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = DriverManager.getConnection(DB_URL, USER, PASS);
            ...
            for (int i = start; i <= end; i++) {
                ...
                String email = "customerTest" + paddedId + "@gmail.com";
                String name = "소비자" + paddedId;
